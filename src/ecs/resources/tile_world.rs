...
impl TileWorldResource {
    pub fn new(gen_package: &GenPackageResource, world_data: &mut WorldData) -> Self {
        ...
        for buffer_x in 0..3usize {
            for buffer_y in 0..3usize {
                ...
                buffer[buffer_idx(buffer_x, buffer_y)].generate((chunk_x, chunk_y), gen_package, world_data);
            }
        }
    ...
    pub fn update_center(&mut self, center_pos: (i32, i32), gen_package: &GenPackageResource, world_data: &mut WorldData) {
        let (offset_x, offset_y) = self.offset;
            ...
            for x in 0..3i32 {
                ...
                for y in 0..3i32 {
                    ...
                    if generate {
                        ...
                        self.buffer[buffer_idx(buffer_x as usize, buffer_y as usize)]
                            .generate((new_chunk_x, new_chunk_y), gen_package, world_data);
                    } else {
                        trace!(
